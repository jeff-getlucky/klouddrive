OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Не вдалося встановити об’єднаний ресурс, схоже, сервер, з яким потрібно об’єднатися, застарий (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Ви можете поділитися з будь-ким, хто використовує сервер KloudDrive або інші сервери та служби, сумісні з Open Cloud Mesh (OCM). Просто введіть їхній Federated Cloud ID у діалоговому вікні спільного доступу. Це виглядає як person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Поділися зі мною через KloudDrive",
    "HTML Code:" : "Код HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Поділіться зі мною через мій #KloudDrive Federated Cloud ID, див. {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Поділіться зі мною через мій #KloudDrive Federated Cloud ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Поділіться зі мною через мій #KloudDrive Federated Cloud ID, див %s"
},
