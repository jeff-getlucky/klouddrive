OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "نمی‌توان یک اشتراک فدرال ایجاد کرد، به نظر می‌رسد سروری که باید با آن فدرال شود خیلی قدیمی است (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "می‌توانید با هر کسی که از سرور KloudDrive یا سایر سرورها و سرویس‌های سازگار با Open Cloud Mesh (OCM) استفاده می‌کند، اشتراک‌گذاری کنید! فقط شناسه ابری فدرال آنها را در گفتگوی اشتراک گذاری قرار دهید. به نظر می رسد person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "هم‌رسانی با من روی نسکت‌کلود",
    "HTML Code:" : "کد HTML :",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "از طریق شناسه ابری فدرال #KloudDrive با من به اشتراک بگذارید، به {url} مراجعه کنید",
    "Share with me through my #KloudDrive Federated Cloud ID" : "از طریق شناسه ابری فدرال #KloudDrive با من به اشتراک بگذارید",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "از طریق شناسه ابری فدرال #KloudDrive با من به اشتراک بگذارید، ببینید%s"
},
