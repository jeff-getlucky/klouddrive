OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Nije moguće uspostaviti udruženo dijeljenje, čini se da je poslužitelj s kojim se udružuje prestar (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Možete dijeliti sa svima koji upotrebljavaju poslužitelj KloudDrive ili druge poslužitelje i usluge kompatibilne s Open Cloud Mesh (OCM)! Samo unesite njihov Federated Cloud ID u dijaloški okvir za dijeljenje. Primjerice: osoba@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Dijelite sa mnom putem KloudDrivea",
    "HTML Code:" : "HTML kod:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Dijeli sa mnom putem mog #ID-ja udruženog oblaka KloudDrivea",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Dijeli sa mnom putem mog #ID-ja udruženog oblaka KloudDrivea, pogledajte %s"
},
