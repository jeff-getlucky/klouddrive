OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "フェデレーション共有を確立できませんでした。連合するサーバーが古すぎます（KloudDrive <= 9）。",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "KloudDrive サーバーまたはその他の Open Cloud Mesh (OCM) 互換のサーバーとサービスを使用しているユーザーであれば、共有ダイアログに Federated Cloud ID を入力するだけで誰とでも共有できます。例: person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "KloudDrive 経由で共有",
    "HTML Code:" : "HTMLコード:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "#KloudDrive の「クラウド共有ID」で私と共有できます。",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "#KloudDrive の「クラウド共有ID」で私と共有できます。こちらを見てください。%s"
},
"nplurals=1; plural=0;");
