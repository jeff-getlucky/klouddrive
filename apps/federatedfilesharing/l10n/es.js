OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "No se ha podido establecer un compartido federado, parece ser que el servidor a federar es demasiado antiguo (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Puedes compartir con cualquiera que use un servidor KloudDrive u otros servidores y servicios compatibles con Open Cloud Mesh (OCM). Simplemente, pon su ID de Nube Federada en el diálogo de compartir. Es algo como persona@nube.ejemplo.com",
    ...
    "Share with me via KloudDrive" : "Compartirlo conmigo vía KloudDrive",
    "HTML Code:" : "Código HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Comparte conmigo a través de mi #KloudDrive Federated Cloud ID, ver {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Compartirlo conmigo a través de mi ID de Nube Federada #KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Compartirlo conmigo a través de mi ID de Nube Federada #KloudDrive, ver %s"
},
