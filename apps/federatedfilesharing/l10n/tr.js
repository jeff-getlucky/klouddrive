OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Birleşik bir paylaşım oluşturulamadı. Birleşik çalışılacak sunucunun sürümü çok eski gibi görünüyor (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "KloudDrive ya da Open Cloud Mesh (OCM) ile uyumlu sunucu ve hizmetler ile paylaşım yapılabilir. Paylaşım penceresine person@cloud.example.com gibi Birleşik Bulut Kodunu yazmanız yeterlidir.",
    ...
    "Share with me via KloudDrive" : "Benimle KloudDrive üzerinden paylaşın",
    "HTML Code:" : "HTML kodu:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "#KloudDrive Birleşik Bulut Kodum ile paylaş,  {url} adresine bakın",
    "Share with me through my #KloudDrive Federated Cloud ID" : "#KloudDrive birleşik bulut kodum üzerinden benimle paylaş",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "#KloudDrive Birleşik Bulut Kodum ile paylaş, %s bölümüne bakın"
},
