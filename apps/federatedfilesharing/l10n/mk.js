OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Неможе да се воспостави федерално споделување, изгледа дека Федералноиот сервер има премногу стара верзија (<= 9).",
    ...
    "Share with me via KloudDrive" : "Сподели со мене",
    "HTML Code:" : "HTML код:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Споделете со мене преку мојот Федерален Cloud ID, види {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Споделете со мене преку мојот Федерален Cloud ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Споделете со мене преку мојот Федерален Cloud ID, види %s"
},
