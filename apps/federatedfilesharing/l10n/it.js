OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Impossibile stabilire una condivisione federata, sembra che il server da federare sia troppo datato (KloudDrive  <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Puoi condividere con chiunque utilizzi server KloudDrive o altri server e servizi Open Cloud Mesh (OCM) compatibili. Ti basta inserire il loro ID di cloud federata nella finestra di condivisione. Assomiglia a persona@cloud.esempio.com ",
    ...
    "Share with me via KloudDrive" : "Condividi con me tramite KloudDrive",
    "HTML Code:" : "Codice HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Condividi con me attraverso il mio ID di cloud federato #KloudDrive, vedi {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Condividi con me attraverso il mio ID di cloud federata #KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Condividi con me attraverso il mio ID di cloud federata #KloudDrive, vedi %s"
},
