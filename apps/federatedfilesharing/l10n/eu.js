OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Ezin izan da federatutako partekatze bat ezarri, badirudi federatu nahi duzun zerbitzaria zaharregia dela (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "KloudDrive zerbitzaria darabilen edo Open Cloud Mesh (OCM) zerbitzuarekin bateragarri den zerbitzua erabiltzen duen edonorekin partekatu dezakezu! Ipini beren Federatutako Hodei IDa partekatze leihoan. Horrelako zerbait izan ohi da: erabiltzailea@KloudDrive.zerbitzaria.com",
    ...
    "Share with me via KloudDrive" : "Partekatu nirekin KloudDrive bidez",
    "HTML Code:" : "HTML kodea:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Partekatu nirekin, nire federatutako #KloudDrive hodei IDa erabiliz, ikus {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Partekatu nirekin, nire federatutako #KloudDrive hodei IDa erabiliz",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Partekatu nirekin, nire federatutako #KloudDrive hodei IDa erabiliz, ikus %s"
},
