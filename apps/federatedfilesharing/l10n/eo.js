OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Ne povis fari federan kunhavon, ŝajnas, ke la servilo federota estas tro malnova (KloudDrive ⩽ 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Vi povas kunhavigi kun iu, kiu uzas KloudDrive aŭ aliaj serviloj kaj servoj kungruaj kun „Open Cloud Mesh (OCM)“! Entajpu simple lian aŭ ŝian federnuban identigilon en la kunhaviga dialogo. Federnuba identigilo similas al persono@nubo.example.com",
    ...
    "Share with me via KloudDrive" : "Kunhavigi kun mi per KloudDrive",
    "HTML Code:" : "HTML-kodo:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Kunhavigi kun mi per mia #KloudDrive-federnuba identigilo",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Kunhavigi kun mi per mia identigilo de #KloudDrive-federnuba identigilo; vidu %s"
},
