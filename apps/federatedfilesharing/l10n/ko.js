OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "연합 공유를 설정할 수 없습니다. 연합하려고 하는 서버가 너무 오래되었습니다(KloudDrive 9 이하).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "KloudDrive 서버나 다른 Open Cloud Mesh(OCM) 호환 서버 및 서비스 사용자와 공유할 수 있습니다! 공유 대화 상자에 연합 클라우드 ID를 입력하십시오. person@cloud.example.com 형식입니다",
    ...
    "Share with me via KloudDrive" : "KloudDrive로 나와 공유하기",
    "HTML Code:" : "HTML 코드:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "내 #KloudDrive 연합 클라우드 ID를 통해서 공유됨",
    "Copy to clipboard" : "클립보드로 복사",
    "Clipboard is not available" : "클립보드를 사용할 수 없습니다.",
    "Copied!" : "복사 성공!",
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "내 #KloudDrive 연합 클라우드 ID를 통해서 공유됨, 더 알아보기: %s"
},
"nplurals=1; plural=0;");
