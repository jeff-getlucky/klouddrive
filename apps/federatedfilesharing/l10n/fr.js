OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Impossible d'établir un partage fédére, il semble que le serveur avec lequel fédérer est trop vieux (KloudDrive <=9)",
    ...
    "Share with me via KloudDrive" : "Partagez avec moi via KloudDrive",
    "HTML Code:" : "Code HTML :",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Partagez avec moi grâce à mon ID de Cloud Fédéré #KloudDrive, voir {url}.",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Partagez avec moi grâce à mon ID de Cloud Fédéré #KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Partagez avec moi grâce à mon ID de Cloud Fédéré #KloudDrive %s"
},
