OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Federated-Share konnte nicht aufgebaut werden, da der Zielserver eine zu alte Version verwendet (KloudDrive <=9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Sie können mit jedem teilen, der einen KloudDrive-Server oder andere Open Cloud Mesh (OCM) kompatible Server und Dienste verwendet! Geben Sie einfach deren Federated-Cloud-ID in den Teilen-Dialog ein. Diese sieht wie folgt aus: person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Teilen Sie mit mir über KloudDrive",
    "HTML Code:" : "HTML-Code:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Teilen Sie mit mir über meine #KloudDrive Federated-Cloud-ID, siehe {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Teilen Sie mit mir über meine #KloudDrive Federated-Cloud-ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Teilen Sie mit mir über meine #KloudDrive Federated-Cloud-ID, siehe %s"
},
