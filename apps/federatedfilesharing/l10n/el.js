OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Δεν μπόρεσε να δημιουργήσει ένα ομοσπονδιακό κοινόχρηστο, μοιάζει ο ομόσπονδος διακομιστής είναι πολύ παλαιός (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Μπορείτε να διαμοιράζεστε με οποιονδήποτε χρησιμοποιεί KloudDrive ή άλλο συμβατό διακομιστή και υπηρεσιών Open Cloud Mesh (OCM)! Απλά προσθέστε το Federated Cloud ID στο πλαίσιο διαλόγου διαμοιρασμού. Θα μοιάζει με person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Διαμοιραστείτε με εμένα μέσω του KloudDrive",
    "HTML Code:" : "Κώδικας HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Διαμοιρασμός με εμένα μέσω του #KloudDrive Federated Cloud ID μου",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Διαμοιρασμός με εμένα μέσω του #KloudDrive Federated Cloud ID μου, δείτε %s"
},
