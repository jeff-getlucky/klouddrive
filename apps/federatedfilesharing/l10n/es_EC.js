OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "No fue posible establecer el elemento compartido, parece que el servidor es obsoleto (KloudDrive <=9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "¡Puedes compartir con cualquier persona que utilice un servidor KloudDrive u otros servidores y servicios compatibles con Open Cloud Mesh (OCM)! Simplemente ingresa su ID de Nube Federada en el diálogo de compartición. Se ve como person@cloud.example.com",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Comparte conmigo a través de mi ID de Nube Federada de #KloudDrive, consulta {url}",
