OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Kunde inte etablera federerad delning, det verkar som servern att federera med är för gammal (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Du kan dela med alla som använder en KloudDrive-server eller andra Open Cloud Mesh (OCM) -kompatibla servrar och tjänster! Anger bara sitt federerade moln-ID i delningsrutan. Det ser ut som person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Dela med mig via KloudDrive",
    "HTML Code:" : "HTML Kod:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Dela med mig genom mitt #KloudDrive federerade moln-ID, se {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Dela med mig genom mitt #KloudDrive federerade moln-ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Dela med mig genom mitt #KloudDrive federerade moln-ID, se %s"
},
