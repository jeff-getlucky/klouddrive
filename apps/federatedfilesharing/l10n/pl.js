OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Nie można ustanowić udostępniania federacyjnego. Wygląda na to, że serwer wybrany do udostępnienia jest zbyt stary (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Możesz udostępniać każdemu, kto używa serwera KloudDrive lub innych serwerów i usług kompatybilnych z Open Cloud Mesh (OCM). Wystarczy, że wpiszesz ID Chmury Federacyjnej w oknie udostępniania, według przykładu: osoba@chmura.przykładowa.com",
    ...
    "Share with me via KloudDrive" : "Udostępnij mi za pomocą KloudDrive",
    "HTML Code:" : "Kod HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Udostępnij mi poprzez mój ID #KloudDrive Chmury Federacyjnej, zobacz {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Udostępnij mi poprzez mój ID #KloudDrive Chmury Federacyjnej",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Udostępnij mi poprzez mój ID #KloudDrive Chmury Federacyjnej, zobacz %s"
},
