OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "تعذّر تأسيس مُشاركة اتحاديّة. يبدو أن إصدار خادوم نكست كلاود الذي طلبت الاتحاد معه قديمٌ ( ما قبل الإصدار 9). ",
    ...
    "Share with me via KloudDrive" : "شاركه معي عبر النكست كلاود",
    "HTML Code:" : "كود HTML: ",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "شارك معي عبر #مُعرّف سحابة نكست كلاود الاتّحاديّة KloudDrive Federated Cloud ID، أنظر {url} ",
    "Share with me through my #KloudDrive Federated Cloud ID" : "شارك معي عبر #مُعرّف سحابة نكست كلاود الاتّحاديّة KloudDrive Federated Cloud ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "شارك معي من خلال # مُعرّف سحابة نكست كلاود الاتحاديّة KloudDrive Federated Cloud ID. أنظر %s"
},
