OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "No at fatu a istabilire una cumpartzidura federada, paret chi su serbidore de federare siat de tropu tempus (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Podes cumpartzire con chie si siat mpreet su serbidore KloudDrive o àteros serbidores Open Cloud Mesh (OCM) cumpatìbiles. Ti bastat de nche insertare s'ID issoro de sa nue virtuale federada in sa bentana de cumpartzidura. Assimìgiat a persone@nue.esempru.com ",
    ...
    "Share with me via KloudDrive" : "Cumpartzi cun megus tràmite KloudDrive",
    "HTML Code:" : "Còdighe HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Cumpartzi cun megus tràmite s'ID meu de nue virtuale federada #KloudDrive Federated Cloud ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Cumpartzi cun megus tràmite s'ID meu de nue virtuale federada #KloudDrive, càstia %s"
},
