OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "A föderált megosztás nem hozható létre, úgy tűnik, hogy a föderálandó kiszolgáló túl régi. (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Bármelyik KloudDrive-kiszolgálót vagy egyéb Open Cloud Mesh-kompatibilis (OCM) kiszolgálót és szolgáltatást használó felhasználóval megoszthatja adatait. Csak tegye a föderált felhőazonosítóját a megosztási párbeszédablakba. Hasonlóan néz ki: person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Ossza meg velem a KloudDriveon keresztül",
    "HTML Code:" : "HTML-kód:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Ossza meg velem a #KloudDrive föderált felhőazonosítóm segítségével, lásd {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Ossza meg velem a #KloudDrive föderált felhőazonosítóm segítségével ",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Ossza meg velem a #KloudDrive föderált felhőazonosítóm segítségével, lásd %s"
},
