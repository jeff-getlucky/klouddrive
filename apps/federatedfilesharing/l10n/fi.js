OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Federoitua jakoa ei voitu muodostaa. Vaikuttaa siltä, että palvelin jonka kanssa federointia yritetään, on versioltaan liian vanha (KloudDrive <= 9).",
    ...
    "Share with me via KloudDrive" : "Jaa kanssani KloudDrivein kautta",
    "HTML Code:" : "HTML-koodi:",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Jaa kanssani käyttäen #KloudDrive ja federoitua pilvitunnistetta",
    "Copy to clipboard" : "Kopioi leikepöydälle",
    "Clipboard is not available" : "Leikepöytä ei ole käytettävissä",
    "Copied!" : "Kopioitu!",
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Jaa kanssani käyttäen #KloudDrive ja federoitua pilvitunnistetta, katso %s"
},
