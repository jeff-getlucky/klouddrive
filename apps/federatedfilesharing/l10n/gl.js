OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Non foi posíbel estabelecer unha compartición federada, semella que o servidor  federar é antigo de máis (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Pode compartir con calquera persoa que empregue servidores KloudDrive, ou outro servidor ou  servizo compatíbel co Open Cloud Mesh (OCM)! Simplemente, introduza o seu ID de nube federada no diálogo de compartir. É algo como persona@cloud.exemplo.com",
    ...
    "Share with me via KloudDrive" : "Comparte comigo a través de KloudDrive",
    "HTML Code:" : "Código HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Comparte comigo a través do meu #KloudDrive Federated Cloud ID, ver {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Comparte comigo a través do meu ID da nube federada de #KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Comparte comigo a través do meu ID da nube federada de #KloudDrive , vexa %s"
},
