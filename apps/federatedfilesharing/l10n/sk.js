OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Nepodarilo sa nadviazať združené zdieľanie, pravdepodobne je verzia servera s ktorým chcete zdieľať príliš zastaraná (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Môžete zdieľať s kýmkoľvek, kto používa server KloudDrive alebo iné kompatibilné servery a služby Open Cloud Mesh (OCM)! Jednoducho vložte ich identifikátor združeného cloudu v dialógovom okne zdieľania. Má to podobu person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Sprístupnené cez KloudDrive",
    "HTML Code:" : "HTML kód:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Zdieľajte so mnou prostredníctvom môjho #KloudDrive Federated Cloud ID, pozrite {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Sprístupnite mi obsah prostredníctvom môjho #KloudDrive Federated Cloud ID",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Sprístupnite mi obsah prostredníctvom môjho #KloudDrive Federated Cloud ID, viac na %s"
},
