OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Não foi possível estabelecer um compartilhamento federado, parece que o servidor a se federar é muito antigo (KloudDrive <= 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Você pode compartilhar com qualquer pessoa que use KloudDrive ou outros servidores compatíveis com o Open Cloud Mesh (OCM)! Basta colocar sua ID de nuvem federada na caixa de diálogo de compartilhamento. Algo como person@cloud.example.com",
    ...
    "Share with me via KloudDrive" : "Compartilhe comigo via KloudDrive",
    "HTML Code:" : "Código HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Compartilhe comigo por meio do meu ID de nuvem federado #KloudDrive, consulte {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Compartilhe comigo através do meu ID de Nuvem Federada #KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Compartilhe comigo através do meu ID de Nuvem Federada #KloudDrive, veja %s"
},
