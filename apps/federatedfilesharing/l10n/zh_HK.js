OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "無法建立聯合雲分享 ，可能是要聯合的伺服器版本太舊（KloudDrive <= 9）。",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "您可以與使用 KloudDrive 伺服器或其他 Open Cloud Mesh（OCM）兼容伺服器和服務的任何人分享！只需將他們的聯盟式雲端 ID 放在分享對話框中。聯盟式雲端 ID 的格式為 person@cloud.example.com ",
    ...
    "Share with me via KloudDrive" : "透過 KloudDrive 與我分享",
    "HTML Code:" : "HTML 代碼：",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "可透過我的 #KloudDrive 聯盟雲端 ID 與我分享，請見 {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "可透過我的 #KloudDrive 聯盟雲端 ID 與我分享",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "可透過我的 #KloudDrive 聯盟雲端 ID 與我分享，請看 %s"
},
"nplurals=1; plural=0;");
