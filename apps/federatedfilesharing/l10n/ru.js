OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Не удалось установить межсерверный общий доступ, на другом сервере установлена устаревшая версия KloudDrive (версия 9.x или более ранняя).",
    ...
    "Share with me via KloudDrive" : "Поделитесь со мной через KloudDrive",
    "HTML Code:" : "HTML код:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Поделитесь со мной через мой #KloudDrive Federated Cloud ID, см. {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Поделитесь со мной через мой #KloudDrive ID в федерации облачных хранилищ",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Поделитесь со мной через мой #KloudDrive ID в федерации облачных хранилищ, смотрите %s"
},
