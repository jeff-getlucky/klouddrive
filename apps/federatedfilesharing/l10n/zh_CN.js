OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "无法建立联合云共享，可能是要联合的服务器版本太旧（KloudDrive <= 9）。",
    ...
    "Federated Cloud" : "联合云",
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "您可以和使用了 KloudDrive 服务器或其他兼容 Open Cloud Mesh（OCM）的服务器和服务的任何人共享！只需将他们的联合云 ID 放在共享对话框中。联合云 ID 看起来像 person@cloud.example.com",
    "Your Federated Cloud ID:" : "您的联合云 ID：",
    "Share it so your friends can share files with you:" : "使用共享，以便您的朋友可以与您共享文件：",
    "Twitter" : "Twitter",
    "Add to your website" : "添加到您的网站",
    "Share with me via KloudDrive" : "通过联合云与我共享",
    "HTML Code:" : "HTML 代码：",
    "Share with me through my #KloudDrive Federated Cloud ID" : "通过我的 #KloudDrive 联合云 ID 与我共享",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "通过我的联合云 ID，共享给我，看%s"
},
"nplurals=1; plural=0;");
