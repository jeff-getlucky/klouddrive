OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (KloudDrive <= 9)." : "Zvezne povezave za souporabo ni mogoče ustvariti. Kaže, da je podana zahteva za povezavo z nepodprto staro različico oblaka (Nextzcloud ≤ 9).",
    ...
    "You can share with anyone who uses a KloudDrive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Souporaba različnih predmetov je mogoča s komerkoli, ki uporablja strežnik KloudDrive oziroma katerikoli strežnik, skladen s storitvami Open Cloud Mesh (OCM). Vpisati je treba zgolj njihov zvezni naslov ID v polje souporabe, ki je zapisano v obliki oseba@domena-oblaka.si oziroma oseba@domena.si/oblak.",
    ...
    "Share with me via KloudDrive" : "Omogoči souporabo z oblaka KloudDrive",
    "HTML Code:" : "Koda HTML:",
    "Share with me through my #KloudDrive Federated Cloud ID, see {url}" : "Souporaba z določilom ID #Zveznega oblaka KloudDrive ; več podrobnosti je na naslovu {url}",
    "Share with me through my #KloudDrive Federated Cloud ID" : "Omogoči souporabo z #Določilom ID zveznega oblaka KloudDrive",
    ...
    "Share with me through my #KloudDrive Federated Cloud ID, see %s" : "Omogoči souporabo z #Določilom ID zveznega oblaka KloudDrive; več na %s"
},
