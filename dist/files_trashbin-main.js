...
(0,_files_src_services_FileAction_ts__WEBPACK_IMPORTED_MODULE_7__.registerFileAction)(new _files_src_services_FileAction_ts__WEBPACK_IMPORTED_MODULE_7__.FileAction({
  ...
  async exec(node) {
    try {
      var _getCurrentUser;
      const destination = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateRemoteUrl)(encodeURI("dav/trashbin/".concat((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_2__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid, "/restore/").concat(node.basename)));
...
/******/ })()
;
//# sourceMappingURL=files_trashbin-main.js.map?v=8264a3d6e3e2f4341bfb