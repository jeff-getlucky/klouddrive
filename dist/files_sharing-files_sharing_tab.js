...
var render = function render() {
  ...
  }), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.t("files_sharing", "Allow upload and editing")))])], 1), _vm._v(" "), _vm.allowsFileDrop ? _c("NcCheckboxRadioSwitch", {
    attrs: {
      "button-variant": true,
      checked: _vm.sharingPermission,
  ...
  }), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.t("files_sharing", "Custom permissions")))]), _vm._v(" "), _c("small", [_vm._v(_vm._s(_vm.t("files_sharing", _vm.customPermissionsList)))])], 1)], 1)]), _vm._v(" "), _c("div", {
...
/******/ })()
;
//# sourceMappingURL=files_sharing-files_sharing_tab.js.map?v=52684fd7f68d0ef6bff0